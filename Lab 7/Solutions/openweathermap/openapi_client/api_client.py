...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.current_weather_data  # this is an instance of the class Endpoint
        api_instance.current_weather_data()  # this invokes api_instance.current_weather_data.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.current_weather_data.callable or self.callable in this class
