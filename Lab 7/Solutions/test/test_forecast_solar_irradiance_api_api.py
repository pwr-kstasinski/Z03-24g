...
from openapi_client.api.forecast_solar_irradiance_api_api import ForecastSolarIrradianceAPIApi  # noqa: E501


class TestForecastSolarIrradianceAPIApi(unittest.TestCase):
    """ForecastSolarIrradianceAPIApi unit test stubs"""

    def setUp(self):
        self.api = ForecastSolarIrradianceAPIApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_forecast_energylatlatlonlon_get(self):
