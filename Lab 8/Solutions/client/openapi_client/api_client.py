...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.receive  # this is an instance of the class Endpoint
        api_instance.receive()  # this invokes api_instance.receive.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.receive.callable or self.callable in this class
