    ...
    def __init__(self, api_client=None):
        ...
        def __delete_messagefrom_messages0(
            ...
            **kwargs
            ...
            >>> thread = api.delete_message(message_id="1232", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()

            Args:
                message_id (str): defaults to "1232", must be one of ["1232"]
                content_type (str): defaults to "application/vnd.api+json", must be one of ["application/vnd.api+json"]
        ...
        def __retrieve_messageinstance0(
            ...
            **kwargs
            ...
            >>> thread = api.retrieve_messageinstance0(message_id="1232", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()
