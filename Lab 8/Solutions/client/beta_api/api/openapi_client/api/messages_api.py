...
class MessagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_messagefrom_messages0(
            self,
            message_id="jsonapi_id_string",
            content_type="application/vnd.api+json",
            **kwargs
        ):
            """Delete Message from Messages  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_message(message_id="jsonapi_id_string", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()

            Args:
                message_id (str): defaults to "jsonapi_id_string", must be one of ["jsonapi_id_string"]
                content_type (str): defaults to "application/vnd.api+json", must be one of ["application/vnd.api+json"]
        ...
        self.delete_messagefrom_messages0 = _Endpoint(
            settings={
                'response_type': (MessageInst1,),
                'auth': [],
                'endpoint_path': '/Messages/{MessageId}/',
                'operation_id': 'delete_messagefrom_messages0',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_messagefrom_messages0
        )
        ...
        def __retrieve_messageinstance0(
            ...
            **kwargs
            ...
            >>> thread = api.retrieve_messageinstance0(message_id="jsonapi_id_string", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()
