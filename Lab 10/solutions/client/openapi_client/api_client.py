...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.mark_read  # this is an instance of the class Endpoint
        api_instance.mark_read()  # this invokes api_instance.mark_read.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.mark_read.callable or self.callable in this class
