...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __read_messages_to_user_from_latest_message_receiver_id_sender_id_latest_post(
            self,
            receiver_id,
            sender_id,
            **kwargs
        ):
            """Read Messages To User From Latest  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.read_messages_to_user_from_latest_message_receiver_id_sender_id_latest_post(receiver_id, sender_id, async_req=True)
            >>> result = thread.get()
        ...
        self.read_messages_to_user_from_latest_message_receiver_id_sender_id_latest_post = _Endpoint(
            settings={
                'response_type': (datetime,),
                'auth': [],
                'endpoint_path': '/message/{receiver_id}/{sender_id}/latest',
                'operation_id': 'read_messages_to_user_from_latest_message_receiver_id_sender_id_latest_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__read_messages_to_user_from_latest_message_receiver_id_sender_id_latest_post
        )
        ...
        def __unread_messages_to_user_from_message_receiver_id_sender_id_unread_post(
            self,
            receiver_id,
            sender_id,
            **kwargs
        ):
            """Unread Messages To User From  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.unread_messages_to_user_from_message_receiver_id_sender_id_unread_post(receiver_id, sender_id, async_req=True)
            >>> result = thread.get()
        ...
        self.unread_messages_to_user_from_message_receiver_id_sender_id_unread_post = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/message/{receiver_id}/{sender_id}/unread',
                'operation_id': 'unread_messages_to_user_from_message_receiver_id_sender_id_unread_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__unread_messages_to_user_from_message_receiver_id_sender_id_unread_post
        )

        def __update_message_status_message_receiver_id_read_put(
            self,
            receiver_id,
            request_body,
            **kwargs
        ):
            """Update Message Status  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_message_status_message_receiver_id_read_put(receiver_id, request_body, async_req=True)
            >>> result = thread.get()
        ...
        self.update_message_status_message_receiver_id_read_put = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/message/{receiver_id}/read',
                'operation_id': 'update_message_status_message_receiver_id_read_put',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_message_status_message_receiver_id_read_put
        )
