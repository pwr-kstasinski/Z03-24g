...
class Ui_UserWidget(object):
    def setupUi(self, UserWidget):
        ...
        UserWidget.setStyleSheet("background: white;")
        ...
        self.user_icon_label_user_widget = QtWidgets.QLabel(self.widget)
        self.user_icon_label_user_widget.setObjectName("user_icon_label_user_widget")
        self.horizontalLayout_2.addWidget(self.user_icon_label_user_widget)
    ...
    def retranslateUi(self, UserWidget):
        ...
        self.user_icon_label_user_widget.setText(_translate("UserWidget", "TextLabel"))
