...
from ...openapi_client.model.user_inst1 import UserInst
    ...
    def __init__(self, api_client=None):
        ...
        def __create_user0(
            ...
            **kwargs
            ...
            Args:
                post_body (UserInst): User attributes
        ...
        def __delete_userfrom_users0(
            self,
            user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39",
            content_type="application/vnd.api+json",
            **kwargs
        ):
            ...
            >>> thread = api.delete_userfrom_users0(user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()

            Args:
                user_id (str): defaults to "e9868444-83a6-4013-bb5e-241bb3ad5e39", must be one of ["e9868444-83a6-4013-bb5e-241bb3ad5e39"]
                content_type (str): defaults to "application/vnd.api+json", must be one of ["application/vnd.api+json"]
        ...
        def __retrieve_conversationfromconversations0(
            self,
            user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39",
            **kwargs
        ):
            ...
            Retrieve Conversation items from the User conversations \"to-many\" relationship  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_conversations(user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39", async_req=True)
            >>> result = thread.get()

            Args:
                user_id (str): User item. defaults to "e9868444-83a6-4013-bb5e-241bb3ad5e39", must be one of ["e9868444-83a6-4013-bb5e-241bb3ad5e39"]
        ...
        self.get_conversations = _Endpoint(
            settings={
                'response_type': (UserConversationsRelColl,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/Users/{UserId}/conversations',
            ...
            api_client=api_client,
            callable=__retrieve_conversationfromconversations0
        )

        def __retrieve_membershipfrommemberships0(
            self,
            user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39",
            **kwargs
        ):
            ...
            Retrieve Membership items from the User memberships \"to-many\" relationship  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_memberships(user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39", async_req=True)
            >>> result = thread.get()
        ...
        self.get_memberships = _Endpoint(
            settings={
                'response_type': (UserMembershipsRelColl,),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/Users/{UserId}/memberships',
            ...
            api_client=api_client,
            callable=__retrieve_membershipfrommemberships0
        )
        ...
        def __retrieve_userinstance0(
            ...
            **kwargs
            ...
            >>> thread = api.retrieve_userinstance0(user_id="e9868444-83a6-4013-bb5e-241bb3ad5e39", content_type="application/vnd.api+json", async_req=True)
            >>> result = thread.get()
