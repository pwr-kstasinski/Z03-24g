...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_conversation0  # this is an instance of the class Endpoint
        api_instance.create_conversation0()  # this invokes api_instance.create_conversation0.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_conversation0.callable or self.callable in this class
